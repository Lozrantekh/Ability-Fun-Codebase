    ...
    if IsServer() then
        ...
        if not self.effectsData["travel"] then
            self.effectsData["travel"] = {
                particle = "particles/econ/misc/high_five/aghanim_puppet_2021/high_five_agh_2021_travel.vpcf",
            }
        end

        if not self.effectsData["impact"] then
            self.effectsData["impact"] = {
                particle = "particles/econ/misc/high_five/aghanim_puppet_2021/high_five_agh_2021_impact.vpcf",
