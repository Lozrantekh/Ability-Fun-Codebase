...
function modifier_bane_fiends_grip_lua:OnCreated(kv)
	...
	self.fiend_grip_mana_drain		= self.ability:GetSpecialValueFor("fiend_grip_mana_drain")
	local fiend_grip_damage			= self.ability:GetSpecialValueFor("fiend_grip_damage")
